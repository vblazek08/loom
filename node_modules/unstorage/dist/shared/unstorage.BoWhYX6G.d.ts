...
interface Storage<T extends StorageValue = StorageValue> {
    ...
    getItem<U extends Extract<T, StorageDefinition>, K extends keyof StorageItemMap<U>>(key: K, ops?: TransactionOptions): Promise<StorageItemMap<U>[K] | null>;
    ...
    setItem<U extends Extract<T, StorageDefinition>, K extends keyof StorageItemMap<U>>(key: K, value: StorageItemMap<U>[K], opts?: TransactionOptions): Promise<void>;
